...
pops = {
	...
	REDUCTION_AFTER_DEFEAT = 2.0, -- After a rebellion is being defeated in combat, its pop militancy will be divided by this number.
	...
	REBEL_OCCUPATION_STRENGTH_BONUS = 1.0, -- the amount of strength given to rebel movements when they occupy a province
