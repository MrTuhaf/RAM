...
country = {
	...
	PARTY_LOYALTY_HIT_ON_WAR_LOSS = 0.55, -- Drops the ruling party loyalty if war is lost.
...
economy = {
	...
	MIN_NUM_FACTORIES_PER_STATE_BEFORE_DELETING_LASSIEZ_FAIRE = 0, -- Min number of factories per state before starting to delete under Lassiez Faire
	...
	FACTORY_PAYCHECKS_LEFTOVER_FACTOR = 0.1, -- % of how much we pay to the pops and capitalists, from the leftovers.
	MAX_FACTORY_MONEY_SAVE = 100000,	-- how much money is stored maximum in a factory.
	SMALL_DEBT_LIMIT = 10000000,
	FACTORY_UPGRADE_EMPLOYEE_FACTOR = 0.66, -- determines how close to the employee limit we need to be before "upgrade all" will upgrade/expand a given factory (1 = 100%).
...
military = {
    ...
    AI_NAVY_TAXBASE_FRACTION = 0.10, -- max of tax base that AI will spend on navy supply costs (based on peacetime costs)
...
diplomacy = {
	...
	INFAMY_INSTALL_COMMUNIST_GOV_TYPE = 7,
	INFAMY_UNINSTALL_COMMUNIST_GOV_TYPE = 2,
	INFAMY_COLONY = 0,
	...
	PRESTIGE_DESTROY_NAVAL_BASES_BASE = 7,
	PRESTIGE_REPARATIONS_BASE = 10,
	PRESTIGE_TRANSFER_PROVINCES_BASE = 10,
	PRESTIGE_REMOVE_CORES_BASE = 5,
	PRESTIGE_PRESTIGE_BASE = 5,
	PRESTIGE_CONCEDE_BASE = 1,
	PRESTIGE_STATUS_QUO_BASE = 5,
	PRESTIGE_ANNEX_BASE = 5,
	PRESTIGE_DEMAND_STATE_BASE = 5,
	PRESTIGE_CLEAR_UNION_SPHERE_BASE = 15, -- Prestige for asserting hegemony
	PRESTIGE_GUNBOAT_BASE = 2, -- Prestige for debt collection
	PRESTIGE_INSTALL_COMMUNIST_GOV_TYPE_BASE = 10,
	PRESTIGE_UNINSTALL_COMMUNIST_GOV_TYPE_BASE = 5,
	PRESTIGE_COLONY_BASE = 2,
		
	PRESTIGE_ADD_TO_SPHERE = 0.05,
	PRESTIGE_RELEASE_PUPPET = 0.1,
	PRESTIGE_MAKE_PUPPET = 0.05,
	PRESTIGE_DISARMAMENT = 0.05,
	PRESTIGE_DESTROY_FORTS = 0.05,
	PRESTIGE_DESTROY_NAVAL_BASES = 0.07,
	PRESTIGE_REPARATIONS = 0.1,
	PRESTIGE_TRANSFER_PROVINCES = 0.1,
	PRESTIGE_REMOVE_CORES = 0.1,
	PRESTIGE_PRESTIGE = 0.05,
	PRESTIGE_CONCEDE = 0.01,
	PRESTIGE_STATUS_QUO = 0.05,
	PRESTIGE_ANNEX = 0.05,
	PRESTIGE_DEMAND_STATE = 0.05,
	PRESTIGE_CLEAR_UNION_SPHERE = 0.15,
	PRESTIGE_GUNBOAT = 0.01, -- Prestige for debt collection
	PRESTIGE_INSTALL_COMMUNIST_GOV_TYPE = 0.05,
	PRESTIGE_UNINSTALL_COMMUNIST_GOV_TYPE = 0.05,
	...
	GW_JUSTIFY_CB_BADBOY_IMPACT = 0.66, -- % deduction of infamy cost for justify CB in great war
	...
	GW_WARSCORE_COST_MOD = 0.66, -- cost reduction factor on warscore needed to fulfill goal if great war
	...
	RANK_5_TENSION_DECAY = -0.2,
	RANK_6_TENSION_DECAY = -0.2,
...
pops = {
	...
	NATIONAL_FOCUS_DIVIDER = 900000.0,
	...
	REDUCTION_AFTER_DEFEAT = 4.0, -- After a rebellion is being defeated in combat, its pop militancy will be divided by this number.
	...
	SLAVE_GROWTH_DIVISOR = 8, -- Slaves have N times lower growth
	...
	ISSUE_MOVEMENT_JOIN_LIMIT = 6,
	ISSUE_MOVEMENT_LEAVE_LIMIT = 5,
	...
	REBEL_OCCUPATION_STRENGTH_BONUS = 0.2, -- the amount of strength given to rebel movements when they occupy a province
...
ai =
{
	...
	ADMINISTRATOR_WEIGHT = 0, -- ai weight for new bureaucrat
	...
	PRODUCTION_WEIGHT = 0.08, -- ai weight for new production
	...
	CHANCE_BUILD_RAILROAD = 0.33, -- chances in % of AI decisions (max value 1.0)
	CHANCE_BUILD_NAVAL_BASE = 0.85,
	CHANCE_BUILD_FORT = 0.05,
	CHANCE_INVEST_POP_PROJ = 0.5,
	CHANCE_FOREIGN_INVEST = 0.15,
	...
	PEACE_TIME_FACTOR = 1.2, -- after months of stubbornness the effect of time passed is multiplied by this
	...
	AGGRESSION_UNCIV_BONUS = 12, -- additional AI civ aggression against uncivs
	FLEET_SIZE = 35, -- AI will attempt to keep fleets of roughly this size (fewer fleets generally results in more competent naval AI)
